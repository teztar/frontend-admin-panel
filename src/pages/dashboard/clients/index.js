...
const applyPagination = (clients, page, rowsPerPage) =>
...
const ClientList = () => {
  ...
  const sortedRoles = applySort(filteredClients, sort);
  const paginatedClients = applyPagination(sortedRoles, page, rowsPerPage);
